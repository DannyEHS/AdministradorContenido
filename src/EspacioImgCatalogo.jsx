const configBasicImgCatalogo = "w-40 h-40 border flex flex-col justify-center items-center";

export default function EspacioImgCatalogo({className="", src="", children}) {
    return(
